...
from legendbot.sql.gvar_sql import gvarstat
from . import *

legend_row = dB.get("BUTTONS_IN_HELP")
legend_emoji = dB.get("EMOJI_IN_HELP")
legend_pic = dB.get("PM_PIC") or "https://telegra.ph/file/6a08bc3d83b51923f47b2.jpg"
cstm_pmp = dB.get("PM_MSG")
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "legendbot_help":
            ...
            if a is not None:
                ...
                PIC = "https://telegra.ph/file/6a08bc3d83b51923f47b2.jpg"
            ALV_PIC = PIC
            ...
            result = builder.article(
                ...
                buttons=[
                    [Button.url("📑 Repo 📑", "https://github.com/The-legendbot/legendbot")],
                    [Button.url("🚀 Deploy 🚀", "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FThe-legendbot%2Flegendbot&template=https%3A%2F%2Fgithub.com%2Fthe-legendbot%2Flegendbot")],
                ],
            )
            ...
            result = builder.article(
                ...
                buttons=[
                    [
                        ...
                        custom.Button.url(
                            "⚡ GROUP ⚡", "https://t.me/legendbot_chat"
                        ),
                    ],
                    [
                        custom.Button.url(
                            "✨ REPO ✨", "https://github.com/The-legendbot/legendbot"),
                        custom.Button.url
                    (
                            "🔰 TUTORIAL 🔰", ""
                    )
    ...
    async def page(event):
        ...
        if event.query.user_id in auth:
            ...
            return await event.answer(
                "Hoo gya aapka. Kabse tapar tapar dabae jaa rhe h. Khudka bna lo na agr chaiye to. © legendbot ™",
                cache_time=0,
                alert=True,
            )
