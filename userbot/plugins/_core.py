...
async def install(event):
    ...
    if len(OUTPUT) > 69:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            ...
            await edit_or_reply(LEGEND_file, f"**Output Too Large. This is the file for the list of plugins in Lêɠêɳ̃dẞø† .\n\n**BY :- {legend_mention}**")
            await event.delete()
